...
public class WorldRender {
    ...
    public void onWorldRenderLast(RenderWorldLastEvent event) {
        ...
        if (passenger instanceof EntityDog) {
            ...
            double distance = (level * 200D)
                - dog.getDistance(dog.coords.getBedX(), dog.coords.getBedY(), dog.coords.getBedZ());
            if (level == 5 || distance >= 0.0D) {
                ...
                AxisAlignedBB boundingBox = AxisAlignedBB
                    .getBoundingBox(
                        ...
                        dog.coords.getBedY(),
                        dog.coords.getBedZ(),
                        dog.coords.getBedX() + 1,
                        dog.coords.getBedY() + 1,
                        dog.coords.getBedZ() + 1)
