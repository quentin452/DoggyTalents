...
public class DoggyTalents {
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { " X ", "XYX", " X ", 'X', Items.bone, 'Y', Items.slime_ball });
        GameRegistry.addShapelessRecipe(
            new ItemStack(ModItems.THROW_BONE, 1, 0),
            new Object[] { new ItemStack(ModItems.THROW_BONE, 1, 1) });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.THROW_BONE, 1, 2),
            new Object[] { " X ", "XYX", " X ", 'X', Items.stick, 'Y', Items.slime_ball });
        GameRegistry.addShapelessRecipe(
            new ItemStack(ModItems.THROW_BONE, 1, 2),
            new Object[] { new ItemStack(ModItems.THROW_BONE, 1, 3) });
        GameRegistry.addShapelessRecipe(
            new ItemStack(ModItems.SUPER_TREAT, 5),
            new Object[] { new ItemStack(ModItems.TRAINING_TREAT, 1), new ItemStack(ModItems.TRAINING_TREAT, 1),
        ...
        GameRegistry.addShapelessRecipe(
            ...
            new Object[] { new ItemStack(ModItems.MASTER_TREAT, 1), new ItemStack(ModItems.MASTER_TREAT, 1),
        ...
        GameRegistry.addShapelessRecipe(
            ...
            new Object[] { new ItemStack(ModItems.MASTER_TREAT, 1), new ItemStack(Items.cooked_beef, 1),
        ...
        GameRegistry.addShapelessRecipe(
            ...
            new Object[] { new ItemStack(ModItems.SUPER_TREAT, 1), new ItemStack(ModItems.SUPER_TREAT, 1),
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { "TUV", "XXX", "YYY", 'T', Items.string, 'U', Items.bone, 'V', Items.gunpowder, 'X',
                Items.sugar, 'Y', Items.wheat });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.COLLAR_SHEARS, 1),
            new Object[] { " X ", "XYX", " X ", 'X', Items.bone, 'Y', Items.shears });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.COMMAND_EMBLEM, 1),
            new Object[] { " X ", "XYX", " X ", 'X', Items.gold_ingot, 'Y', Items.bow });
        GameRegistry.addRecipe(
            new ItemStack(ModBlocks.FOOD_BOWL, 1),
            new Object[] { "XXX", "XYX", "XXX", 'X', Items.iron_ingot, 'Y', Items.bone });
        GameRegistry.addRecipe(
            new ItemStack(ModBlocks.DOG_BATH, 1),
            new Object[] { "XXX", "XYX", "XXX", 'X', Items.iron_ingot, 'Y', Items.water_bucket });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.CHEW_STICK, 1),
            new Object[] { "SW", "WS", 'W', Items.wheat, 'S', Items.sugar });
        GameRegistry
            .addRecipe(new ItemStack(ModItems.WOOL_COLLAR, 1), new Object[] { "SSS", "S S", "SSS", 'S', Items.string });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.TREAT_BAG, 1),
            new Object[] { "LCL", "LLL", 'L', Items.leather, 'C', ModItems.CHEW_STICK });

        GameRegistry.addRecipe(
            new ItemStack(ModItems.CAPE, 1),
            new Object[] { "S S", "LWL", "WLW", 'L', Items.leather, 'S', Items.string, 'W', Blocks.wool });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.CAPE_COLOURED, 1),
            new Object[] { "S S", "LLL", "LLL", 'L', Items.leather, 'S', Items.string });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.LEATHER_JACKET, 1),
            new Object[] { "L L", "LWL", "LWL", 'L', Items.leather, 'W', new ItemStack(Blocks.wool) });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.FANCY_COLLAR, 1, 1),
            new Object[] { "BWB", "WCW", "BSB", 'C', new ItemStack(ModItems.WOOL_COLLAR), 'B',
                new ItemStack(Items.dye, 1, 0), 'W', new ItemStack(Items.dye, 1, 15), 'S',
                new ItemStack(Items.string) });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.FANCY_COLLAR, 1, 1),
            new Object[] { "WBW", "BCB", "WSW", 'C', new ItemStack(ModItems.WOOL_COLLAR), 'B',
                new ItemStack(Items.dye, 1, 0), 'W', new ItemStack(Items.dye, 1, 15), 'S',
                new ItemStack(Items.string) });
        GameRegistry.addShapelessRecipe(
            new ItemStack(ModItems.FANCY_COLLAR, 1, 2),
            new Object[] { new ItemStack(ModItems.WOOL_COLLAR), new ItemStack(Items.string),
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { "S S", "GSG", 'S', Items.stick, 'G', new ItemStack(Blocks.glass_pane) });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.TINY_BONE, 1),
            new Object[] { "BI", "IB", 'B', Items.bone, 'I', Items.iron_ingot });
        GameRegistry.addRecipe(
            new ItemStack(ModItems.BIG_BONE, 1),
            new Object[] { "BI", "IB", "BI", 'B', Items.bone, 'I', Items.iron_ingot });

        GameRegistry.addRecipe(
            new ItemStack(ModItems.RADIO_COLLAR, 1),
            new Object[] { "XX", "YX", 'X', Items.iron_ingot, 'Y', Items.redstone });
        GameRegistry.addShapelessRecipe(
        ...
        CraftingManager.getInstance()
            .getRecipeList()
            .add(new RecipeDogBed());
        CraftingManager.getInstance()
            .getRecipeList()
            .add(new RecipeDogCollar());
        CraftingManager.getInstance()
            .getRecipeList()
            .add(new RecipeDogCape());
        ...
        RecipeSorter.register(
            "doggytalents:dogcollar",
            RecipeDogCollar.class,
            RecipeSorter.Category.SHAPELESS,
            "after:minecraft:shapeless");
        RecipeSorter.register(
            "doggytalents:dogcape",
            RecipeDogCape.class,
            RecipeSorter.Category.SHAPELESS,
            "after:minecraft:shapeless");
