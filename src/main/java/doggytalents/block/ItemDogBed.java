...
public class ItemDogBed extends ItemBlock {
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List tooltip, boolean advanced) {
        ...
        if (stack.hasTagCompound() && stack.getTagCompound()
            ...
            else tooltip.add(EnumChatFormatting.RED + StatCollector.translateToLocal("dogBed.woodError"));
            ...
            else tooltip.add(EnumChatFormatting.RED + StatCollector.translateToLocal("dogBed.woolError"));
        }
    }
}
