...
public class BlockFoodBowl extends BlockContainer {
    ...
    @Override
    public boolean onBlockActivated(World worldIn, int x, int y, int z, EntityPlayer playerIn, int par6, float hitX,
        ...
        if (worldIn.isRemote) {
            ...
            if (stack != null && stack.getItem() == ModItems.TREAT_BAG) {
                ...
                for (int i = 0; i < treatBag.getSizeInventory(); i++) treatBag.setInventorySlotContents(
                    i,
                    DogUtil.addItem(tileentitydogfoodbowl.inventory, treatBag.getStackInSlot(i)));
    ...
    public void onEntityCollidedWithBlock(World worldIn, int x, int y, int z, Entity entityIn) {
        ...
        if (entityIn instanceof EntityItem) {
            ...
            if (itemstack1 != null && itemstack1.stackSize != 0) entityItem.setEntityItemStack(itemstack1);
            else {
                entityItem.setDead();
            ...
            if (tileentity != null) {
                for (int i1 = 0; i1 < foodBowl.inventory.getSizeInventory(); ++i1) {
                    ...
                    if (itemstack != null) {
                        ...
                        for (float f2 = this.random.nextFloat() * 0.8F + 0.1F; itemstack.stackSize > 0; worldIn
                ...
                worldIn.notifyBlocksOfNeighborChange(x, y, z, block);
            }
        }
