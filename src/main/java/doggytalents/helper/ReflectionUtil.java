...
public class ReflectionUtil {
    ...
    public static <T> T invokeMethod(Class<?> class1, String methodName, Class<T> methodType, Object instance,
    ...
    // Invoke void method
    public static void invokeMethod(Class<?> class1, String methodName, Object instance, Class[] argsClass,
        Object[] args) {
        try {
