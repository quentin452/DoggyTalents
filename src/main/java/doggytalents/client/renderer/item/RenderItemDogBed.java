...
public class RenderItemDogBed implements IItemRenderer {
    ...
    public void renderInvBlockBedding(RenderBlocks renderer, Block block, String beddingId) {
        ...
        renderer.renderFaceYNeg(
            ...
            0.0D,
            0.0D,
            renderer.getIconSafe(DogBedRegistry.BEDDINGS.getIcon(beddingId, 0)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        renderer.renderFaceYPos(
            ...
            0.0D,
            0.0D,
            renderer.getIconSafe(DogBedRegistry.BEDDINGS.getIcon(beddingId, 1)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        ...
        renderer.renderFaceZNeg(
            ...
            0.0D,
            0.0D,
            renderer.getIconSafe(DogBedRegistry.BEDDINGS.getIcon(beddingId, 2)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, 1.0F);
        renderer.renderFaceZPos(
            ...
            0.0D,
            0.0D,
            renderer.getIconSafe(DogBedRegistry.BEDDINGS.getIcon(beddingId, 3)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        ...
        renderer.renderFaceXNeg(
            ...
            0.0D,
            0.0D,
            renderer.getIconSafe(DogBedRegistry.BEDDINGS.getIcon(beddingId, 4)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(1.0F, 0.0F, 0.0F);
        renderer.renderFaceXPos(
            ...
            0.0D,
            0.0D,
            renderer.getIconSafe(DogBedRegistry.BEDDINGS.getIcon(beddingId, 5)));
        tessellator.draw();
        GL11.glTranslatef(0.5F, 0.5F, 0.5F);
    }
    ...
    public void renderInvBlockCasing(RenderBlocks renderer, Block block, String casingId) {
        ...
        tessellator.setNormal(0.0F, -1.0F, 0.0F);
        renderer
            .renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, renderer.getIconSafe(DogBedRegistry.CASINGS.getIcon(casingId, 0)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        renderer
            .renderFaceYPos(block, 0.0D, 0.0D, 0.0D, renderer.getIconSafe(DogBedRegistry.CASINGS.getIcon(casingId, 1)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, -1.0F);
        renderer
            .renderFaceZNeg(block, 0.0D, 0.0D, 0.0D, renderer.getIconSafe(DogBedRegistry.CASINGS.getIcon(casingId, 2)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, 1.0F);
        renderer
            .renderFaceZPos(block, 0.0D, 0.0D, 0.0D, renderer.getIconSafe(DogBedRegistry.CASINGS.getIcon(casingId, 3)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(-1.0F, 0.0F, 0.0F);
        renderer
            .renderFaceXNeg(block, 0.0D, 0.0D, 0.0D, renderer.getIconSafe(DogBedRegistry.CASINGS.getIcon(casingId, 4)));
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(1.0F, 0.0F, 0.0F);
        renderer
            .renderFaceXPos(block, 0.0D, 0.0D, 0.0D, renderer.getIconSafe(DogBedRegistry.CASINGS.getIcon(casingId, 5)));
        tessellator.draw();
        GL11.glTranslatef(0.5F, 0.5F, 0.5F);
    }
}
