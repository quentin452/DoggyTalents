...
public class RenderDog extends RenderLiving {
    ...
    protected void renderLivingAt(EntityLivingBase entity, double x, double y, double z) {
        ...
        if (dog.isEntityAlive() && dog.isPlayerSleeping()) super.renderLivingAt(dog, x, y + 0.5F, z);
        else super.renderLivingAt(dog, x, y, z);
    }
    ...
    protected void renderModel(EntityLivingBase entity, float p_77036_2_, float p_77036_3_, float p_77036_4_,
        ...
        for (int i = 4; i < 6; ++i) {
            ...
            if (j > 0) {
                ...
                this.renderPassModel
                    .render(entity, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
    ...
    protected int shouldRenderPass(EntityLivingBase entity, int renderPass, float partialTickTime) {
        ...
        if (renderPass == 4 && (dog.getHealth() == 1 && dog.isImmortal() && Constants.RENDER_BLOOD)) {
            ...
            if (dog.worldObj.getWorldTime() >= 12000) this.bindTexture(ResourceLib.MOB_LAYER_SUNGLASSES_NIGHT);
            else this.bindTexture(ResourceLib.MOB_LAYER_SUNGLASSES);
            GL11.glColor3f(1.0F, 1.0F, 1.0F);
            return 1;
        } else return -1;
    }
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        if (dog.isTamed()) return ResourceLib.getTameSkin(dog.getTameSkin());
    ...
    protected void renderLivingLabel(Entity p_147906_1_, String p_147906_2_, double p_147906_3_, double p_147906_5_,
        double p_147906_7_, int p_147906_9_, float scale) {
