...
public class ItemWoolCollar extends ItemDT {
    ...
    public int getColorFromItemStack(ItemStack stack, int pass) {
        if (stack.hasTagCompound()) if (stack.getTagCompound()
    ...
    public void getSubItems(Item itemIn, CreativeTabs tab, List subItems) {
        for (int i = 0; i < 16; i++) {
            ...
            baseColours.getTagCompound()
                .setInteger("collar_colour", (((i1 << 8) + j1) << 8) + k1);
    ...
    public int getColor(ItemStack stack) {
        ...
        if (nbttagcompound != null) return nbttagcompound.getInteger("collar_colour");
    ...
    public void removeColor(ItemStack stack) {
        ...
        if (nbttagcompound != null) nbttagcompound.removeTag("collar_colour");
