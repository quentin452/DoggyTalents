...
public class CoordUtil {
    ...
    public int getBedX() {
        try {
            return new Integer(this.getSkillsLevels()[0]);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public int getBedY() {
        try {
            return new Integer(this.getSkillsLevels()[1]);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public int getBedZ() {
        try {
            return new Integer(this.getSkillsLevels()[2]);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public int getBowlX() {
        try {
            return new Integer(this.getSkillsLevels()[3]);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public int getBowlY() {
        try {
            return new Integer(this.getSkillsLevels()[4]);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public int getBowlZ() {
        try {
            return new Integer(this.getSkillsLevels()[5]);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public void resetBedPosition() {
        this.dog.getDataWatcher()
            .updateObject(28, "-1:-1:-1:" + getBowlX() + ":" + getBowlY() + ":" + getBowlZ());
    }

    public void resetBowlPosition() {
        this.dog.getDataWatcher()
            .updateObject(28, getBedX() + ":" + getBedY() + ":" + getBedZ() + ":-1:-1:-1");
    }
    ...
    private String getLevelString() {
        return dog.getDataWatcher()
            .getWatchableObjectString(28);
    }
    ...
    public void readFromNBT(NBTTagCompound tagCompound) {
        if (tagCompound.hasKey("coords")) this.dog.getDataWatcher()
            .updateObject(28, tagCompound.getString("coords"));
        else this.resetBedPosition();
    }
}
