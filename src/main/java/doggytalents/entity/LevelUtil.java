...
public class LevelUtil {
    ...
    public void readTalentsFromNBT(NBTTagCompound tagCompound) {
        if (tagCompound.hasKey("levels", 8)) this.dog.getDataWatcher()
            .updateObject(24, tagCompound.getString("levels"));
        else this.dog.getDataWatcher()
            .updateObject(24, "0:0");
    }
    ...
    public void setLevel(int level) {
        this.dog.getDataWatcher()
            .updateObject(24, level + ":" + this.getDireLevel());
        this.updateHealthModifier();
    }

    public void setDireLevel(int level) {
        this.dog.getDataWatcher()
            .updateObject(24, this.getLevel() + ":" + level);
        this.updateHealthModifier();
    }
    ...
    public void updateHealthModifier() {
        ...
        if (iattributeinstance.getModifier(HEALTH_BOOST_ID) != null) iattributeinstance.removeModifier(healthModifier);
